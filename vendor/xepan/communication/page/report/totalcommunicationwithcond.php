...
class page_report_totalcommunicationwithcond extends \xepan\base\Page{
	...
	function page_index(){
		...
		$model_field_array = ['total_communication_withoutphoneattand'];//,'unique_lead','communication','total_email','total_comment','total_meeting','total_sms','total_telemarketing','total_call','dial_call','received_call','unique_leads_from','unique_leads_to','attended_others_meeting'];
		...
		if($form->isSubmitted()){
			// var_dump($this->sub_type_2_fields);

...
class page_telemarketing extends \xepan\base\Page{
	...
	function init(){
		...
		*/
		...
		$view_lead->setModel($model_lead, ['priority___','effective_name','organization','type','city','contacts_comma_seperated','score___','status','state','county','last_communication___','days_ago____','branch_id']);
		...
		// quick filter
		$frm = $view_lead->grid->addQuickSearch(['effective_name','organization','contacts_comma_seperated']);
